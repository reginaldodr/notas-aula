...
%----------- Caixa de Teoremas e outras caixas (tcolorbox) ---------
...
\newtcbtheorem[use counter from=theoremb]{definb}{Definição}%
{
    enhanced,
    drop fuzzy shadow,
    colback=blue!5!white,
...
\newtcbtheorem[use counter from=theoremb]{propb}{Proposição}%
{
    enhanced,
    drop fuzzy shadow,
    colback=blue!5!white,
...
\newtcbtheorem[use counter from=theoremb]{exeb}{
\includegraphics[scale=0.3]{figuras/base/exemplo.png} Exemplo}%
{
    enhanced,
    drop fuzzy shadow,
...
\newtcbtheorem[number within=chapter]{casab}{
\includegraphics[scale=0.035]{figuras/base/w-homework.png} Para Casa}%
{
    enhanced,
    drop fuzzy shadow,
    colback=red!5!white,
    ...
    description delimiters parenthesis,
    separator sign none,
	bookmark*={level=1}{Para Casa \thetcbcounter},
}{casa}
...
\coffeestainD{1}{0.3}{90}{-7cm}{12cm}
\coffeestainA{0.5}{0.7}{-25}{6cm}{10cm}
  }
  {-10pt}
