...
\marcador{subsection}{Superfícies Cilíndricas}


Uma \dt{superfície cilíndrica} é aquela gerada por uma reta $\ell$ que se move ao longo de uma curva plana dada, de modo que a reta $\ell$ sempre esteja paralela a uma reta fixa. A reta $\ell$ é chamada de \dt{geratriz} e a curva de \dt{diretriz}.
...
\marcador{subsection}{Superfícies Quádricas}
...
Associe as equações às respectivas quádricas.
%------- ENUNCIADO -------------------
\begin{multicols}{3}
\begin{enumerate}
	\item \(x^2+y^2+4z^2=10\)
	\item \(z^2+4y^2-4x^2=4\)
	\item \(9y^2+z^2=16\)
	\item \(y^2+z^2=x^2\)
	\item \(x=y^2-z^2\)
	\item \(x=-y^2-z^2\)
...
%	\includegraphics[scale=0.35]{figuras/quadricas/exerc12-6D.png}
%\end{minipage}
%------ abcd ---------------------
\begin{minipage}{0.45\textwidth}
	\includegraphics[scale=0.6]{figuras/quadricas/exerc12-6A.png}
\end{minipage}\ \ \
%-------------- efgh
\begin{minipage}{0.45\textwidth}
	\includegraphics[scale=0.6]{figuras/quadricas/exerc12-6B.png}
\end{minipage}
\bigskip

%------- hijk ---------------------
\begin{center}
	\includegraphics[scale=0.7]{figuras/quadricas/exerc12-6C.png}
\end{center}
\newpage


\marcador{subsection}{Eu vejo quádricas...Todo o tempo!}

\begin{center}
\includegraphics[scale=0.3]{figuras/quadricas/meme-osextosentido}
\end{center}
\bigskip
...
\noindent{\large \textbf{Batata Pringles} }

\begin{center}
	\includegraphics[scale=.5]{figuras/quadricas/pringles.png}
\end{center}

\noindent{\large \textbf{Aplicações na Engenharia} }


\begin{center}
	\includegraphics[scale=.5]{figuras/quadricas/aplicacoes.png}
\end{center}

\newpage


\noindent{\large \textbf{Aplicações na Arquitetura} }


\begin{center}
	\includegraphics[scale=.4]{figuras/quadricas/arquitetura/manantiales.jpg}

	Restaurante Los Manantiales -- Félix Candela (México)

\bigskip

	\includegraphics[scale=.4]{figuras/quadricas/arquitetura/manantiales_diagrama.jpg}
...
\begin{center}
\includegraphics[scale=1.35]{figuras/quadricas/arquitetura/vila-velha.png}
