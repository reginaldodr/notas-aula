...
\begin{center}
\includegraphics[scale=1.7]{figuras/polar/polar-grid.png}
\end{center}
\newpage
...
\marcador{subsection}{Relação entre coordenadas cartesianas e polares}
%\[
...
\begin{exeb}{}{} Esboce a curva que é representada pelas equações polares abaixo.
%\begin{multicols}{3}
		\begin{enumerate}[(a)]
		\item $r=2$
...
\begin{exeb}{}{} Esboce a curva que é representada pela seguinte equação polar
\[r=1+\cos(\theta) \text{ (cardioide)}\]
\end{exeb}

\begin{center}
\includegraphics[scale=.7]{figuras/grafico-aux-cardioide.png}
\end{center}

\begin{center}
\includegraphics[scale=1]{figuras/polar/cardioide1.png}
\end{center}
\newpage

\marcador{subsection}{Plotando a Cardioide no Python}
...
\begin{center}
\includegraphics[scale=.9]{figuras/polar/cardioide3.png}
\end{center}
