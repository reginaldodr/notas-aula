...
\marcador{subsection}{Equação Paramétrica de uma Reta}

%\textbf{{\large Equação Paramétrica de uma Reta}}
%\pdfbookmark[1]{Retas}{retas}
...
\marcador{subsection}{Equação Cartesiana do Plano no Espaço}
...
\begin{casab}{}{} Resolve os exercícios:
	\begin{enumerate}
