...
% 2. Adicione o seu código no background de todas as páginas
%\AddToShipoutPictureBG{%
% \includegraphics[width=\paperwidth,height=\paperheight]{fundo-pontilhado.pdf}%
%}

%\mainmatter
\include{aulas/introducao}
%------------------------------------
\chapter{Elementos de Geometria Analítica}
\input{aulas/retas-planos}
\include{aulas/quadricas}
\include{aulas/polares}
%-------------------------------------
\chapter{Funções Vetoriais}
\input{aulas/funcoes-vetoriais}
\include{aulas/calculovetorial}
---------------------------------------
