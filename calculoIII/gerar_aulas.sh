...
rm -f introducao.aux introducao.log introducao.out introducao.toc introducao.idx
...
rm -f retas-planos.aux retas-planos.log retas-planos.out retas-planos.toc retas-planos.idx
...
# Remove os arquivos auxiliares gerados na raiz
rm -f quadricas.aux quadricas.log quadricas.out quadricas.toc quadricas.idx
